...
$_CHC_LANG = array_merge( $_CHC_LANG, array(
	...
	'downloads' => 'İndirdikleri', /* DOWNLOAD */
	'logs' => 'Log verileri',
	'news' => 'Güncel',
	'help' => 'Yardım &amp; İletişim',
	'logout' => 'Oturumu kapat',
	'statistics' => 'İstatistikleri',
	'settings' => 'Ayarları',
	'login' => 'Oturumu aç',
	'logout_successful' => 'Oturum açıldı.',
	'logout_not_successful' => 'Oturumu açarken bir hata oldu.',
	'logout_affirmation' => 'Oturumu açmak için tuşa bas.<br />Bir önceki kaydettiği cookie silinecek.',
	'security_alert_install_directory' => '<span style="color: #FF0000">Önemli:</span><br />Kurduktan sonra »install« klasörü silinmeli!',
	'welcome_message' => 'chCounter yönetim bölümünde hoşgeldin!',


	/* News (./administration/new.inc.php) */
	'error_contacting_news_file' => 'Hata: http://chCounter.org\'teki news dosyası ulaşılamadı.',
	'no_news_available_at_present' => 'Şu anda yeni bir mesaj yok.',


	/* Logs (./administration/logs.inc.php) */
	'date_time' => 'Tarih, saat',
	'visitor_details' => 'Ziyaretçi detayları (Yönetim)',
	'no_visitors_logged_yet' => 'Ziyaretçi henüz kaydetilmemiş.',


	/* detailed user information (./administration/visitor_details.php) */
	'browser\'s_language_settings' => 'Tarayıcının dil ayarları',
	'not_available' => 'yok',
	'preferred:' => 'tercih ettiği:',	
	'javascript' => 'JavaScript',
	'js_available_and_activated' => 'etkili',
	'js_not_available_or_deactivated' => 'etkili değil',
	'visited_pages' => 'ziyaret ettiği sayfalar',
	'close_window' => 'pencere kapat',

	/* Settings */
	'general_settings' => 'Genel',
	'global_settings' => 'Genel ayarları',
	'user_management' => 'Kullanıcı yönetimi',
	'counter' => 'Sayaç',
	'counter_settings' => 'Ayarları',
	'edit_counter_records' => 'Sayacı değiştir',
	'general' => 'Genel',
	'(de)activate_statistics' => 'İstatistikleri etkinleştir / devre dışı bırak',
	'database_operations:' => 'Veritaban operasyonları:',
	'reset_statistics' => 'İstatistikleri sıfırla',
	'data_cleanup' => 'Veri temizliği',
	'lists:' => 'Listeler:',
	'blacklists' => '»Kara listeler«',
	'exclusion_lists' => '»bakılmıyacak«',
	'hideout_lists' => '»saklanacak«',
	'statistics_display' => 'İstatistik görüntüsü:',
	'access_authorisations' => 'erişim yetkileri',
	'top/latest' => 'en çok / son &hellip;',
	'referrers,_search_engines_and_keywords' => 'Referrer, arama motorları ve anahtar kelimleri',
	'visitors_details' => 'Ziyaretçi detayları',
	'all_lists' => '»Bütün liste«',
	'pages_and_currently_online' => 'Sayfalar &amp; başlı olanlar',
	'wrong_password' => 'Şifre yanlış!',
	'configuration_updated' => 'Ayarları güncellendi.',
	'please_fill_out_each_required_field' => 'Lütfen gerekli yerleri doldurun!',
	'settings_description_guest_login' => 'Burada misafırlara istatistik bakma izini verilir.',
	'settings_description_admin_login' => 'Burada kendin adın ve şifren değiştirebilirsin. Eğer değiştirmek istemiyorsan şifre yerleri doldurma.',
	'save_settings' => 'Ayarları kaydet',
	'administrator' => 'Yönetmen',
	'guest_login' => 'Misafır girişi',
	'name:' => 'Adı:',
	'old_password:' => 'eski şifre:',
	'new_password:' => 'yeni şifre:',
	'new_password_(repetition):' => 'yeni şifre:<br />(tekrar)',
	'general_counter_settings' => 'Genel sayaç ayarları',
	'URLs' => 'Adresler',
	'hp_url' => 'Websitenin adresi:',
	'url_of_counter_directory' => 'Sayaç klasörün adresi:',
	'charset' => 'Kodlama',
	'homepage_charset:' => 'Websitenin yazıtipi',
	...
	'enable_daylight_saving_time:' => 'Gün ışığından yararlanma etkinleştir:',
	'use_admin_blocking_cookie' => 'Yönetici kendisi sayma (cookie ile):',
	'do_not_count_robots' => 'robotlar sayma (arama motorları dahil):',
	'language_settings' => 'Dil ayarları',
	'default_language' => 'Arayüz dili:',
	'administration_language' => 'Yöneticinin arayüz dili:',
