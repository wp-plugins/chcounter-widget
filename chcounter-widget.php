...
class chCounterWidget
{
	...
	function initialize()
	{
		...
		// add stylesheet before theme styles
		add_action( 'wp_enqueue_scripts', array(&$this, 'addStyles'), 1 );
...
?>";
	...
	function addStyles()
	{
		wp_enqueue_style('chcounter', $this->plugin_url."/style.css", array(), '1.0', 'all');
	}
