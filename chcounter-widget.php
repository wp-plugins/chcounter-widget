...
TEMPLATE;
			...
			echo $before_widget . $before_title . 'chCounter Error' .$after_title.__( 'Could not find the chcounter installation. Please check your settings.', 'chcounter' ).$after_widget;
		}
