...
= 3.1.6 =
* NEW: add warning and link to chCounter installation directory if it exists and link to delete it
...
= 3.1.3 = 
* BUGFIX: one small notice in widget control panel

= 3.1.2 =
* BUGFIX: save parameter order without javascript
